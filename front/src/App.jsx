  ...
  return (
    <>
      <div className="relative w-96 h-96 mx-auto">
        ...
        <button className="absolute top-1/2 left-1/2 w-24 h-24 bg-gray-800 rounded-full border-4 border-white transform -translate-x-1/2 -translate-y-1/2 cursor-pointer text-white">
          Start
        </button>
      </div>
    </>
